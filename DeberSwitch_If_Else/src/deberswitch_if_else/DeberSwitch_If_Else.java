 ...
 */
package deberswitch_if_else;

/**
 *
 * @author Cristian
 */
public class DeberSwitch_If_Else {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("If Else con respecto a un numero dado");
        int a=15;
        ...
        System.out.println("Switch con respecto a un numero dado");
        int b=1;
